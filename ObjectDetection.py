...
def image_pyramid(image, scale=1.5, minSize=(300, 300)):
...
WIN_STEP = 16
ROI_SIZE = (64, 64)
INPUT_SIZE = (256, 256)     #This will be the input size to the model
...
for i, prob in enumerate(probs):
    ...
    box = locs[i]
    if prob[0] >= args["min_conf"]:
        boxes.append(box)
        probs_soccer.append(prob[0])
